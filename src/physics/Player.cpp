...
namespace physics
{
    ...
    bool Player::processInputTick(const ControllerState& controllerState, int tickNanos)
    {
    ...
    bool Player::processPartialInputTick(const ControllerState& controllerState, int tickNanos, int intoTick)
    {
        glm::vec4 up4{0, 1, 0, 1};
        glm::vec4 forward4{0, 0, -1, 1};
        glm::vec4 right4{1, 0, 0, 1};
