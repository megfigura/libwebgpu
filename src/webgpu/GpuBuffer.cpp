...
GpuBuffer::GpuBuffer(RawResource res, uint64_t offset, uint64_t size, WGPUBufferUsage usage) : m_resource{std::move(res)}, m_offset{offset}, m_bufferDesc{WGPU_BUFFER_DESCRIPTOR_INIT}, m_buffer{nullptr}
{
